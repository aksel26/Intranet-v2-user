...
import { mealStore, useCalendarStore } from "@/store/benefit/meal/mealStore";
import type { TMyVacations } from "@/types/apiTypes/apiTypes";
import { calendarIcon } from "@/utils/meals/calendarIcon";
...
export default function Calendar() {
  ...
  const { data, isLoading, isError } = useApiQuery(["vacationAll", params], () => leaveService.getMyLeaves(params));

  const vacationData = data?.data.data;
