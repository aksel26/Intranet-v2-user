...
import { Badge, Button, Group, Loader, Modal, Paper, Stack, Text, Title } from "@mantine/core";
    ...
    <Modal opened={opened} onClose={close} title="첨부파일" centered size={"md"}>
      ...
      {loading ? (
        ...
        <div style={{ position: "relative", width: "100%", height: "300px" }}>
          <NextImage src={preview} alt="첨부 이미지" fill style={{ objectFit: "contain" }} className="transition-all duration-200" />
        </div>
      ) : (
