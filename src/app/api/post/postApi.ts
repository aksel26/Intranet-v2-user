...
export const checkIn = (values: any) => postApi.post(`/users/intranet/check-in`, values);

export const checkOut = (values: any) => postApi.put(`/users/intranet/check-out`, values);

export const leave = (values: any) => postApi.post(`/users/intranet/leave`, values, { headers: { "Content-Type": "multipart/form-data" } });
